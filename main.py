...
if __name__ == '__main__':
    ...
    make_parser = subparsers.add_parser(
        'make', help='Build models from model specifications')
    make_parser.add_argument('-f', '--from', required=True, type=str,
                             help='Model specification file (generated by `main.py generate`)')
    make_parser.add_argument('-o', '--output', required=True, type=str,
                             help='Directory to output place output in. Must already exist.')
